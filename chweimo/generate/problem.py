...
from chweimo.generate.density_estimator import GMMDensity
...
class MyProblem(ElementwiseProblem):
    ...
    def __init__(self, x_orig, model, xl, xu, MAD, GMM, change_class, plausible):
...
def get_problem(X, Y, model, x_orig, change_class, plausible):
    ...
    prob = MyProblem(x_orig, model, xl, xu, MAD, GMM, change_class, plausible)
